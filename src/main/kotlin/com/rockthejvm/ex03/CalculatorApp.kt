package com.rockthejvm.ex03

import com.rockthejvm.calculator.CalculatorLogic
...
fun main() {
    SwingUtilities.invokeLater {
        val frame = JFrame("calculator_app - It's Alive!")
        ...
        val expressionField = JTextField(logic.expression).apply {
            isEditable = false
        }
        val resultField = JTextField(logic.result).apply {
            isEditable = false
        }

        fun refresh() {
            expressionField.text = logic.expression
            resultField.text = logic.result
        }
